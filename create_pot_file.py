    ...
    for root, _dirs, files in os.walk(directory):
        for file in files:
            if file.endswith('.py'):
                ...
                if 'annotate_params' in file or \
                '__init__' in file or \
                'backend_mavftp' in file or \
                'extract_param_defaults' in file or \
                'download_numbers.py' in file or \
                'get_release_stats' in file or \
                'mavftp_example' in file or \
                'param_pid_adjustment_update' in file or \
                'safe_eval' in file or \
                'tempcal_imu' in file:

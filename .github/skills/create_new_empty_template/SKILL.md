...
6. **Move and commit**: After completing all steps, move the generated project directory into
   `ardupilot_methodic_configurator/vehicle_templates/ArduCopter` and commit it to the repository.

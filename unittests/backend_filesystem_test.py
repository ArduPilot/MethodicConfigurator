...
class TestLocalFilesystem(unittest.TestCase):  # pylint: disable=missing-class-docstring
    @patch("os.path.isdir")
    @patch("os.listdir")
    ...
    def test_re_init(
        ...
        self.assertEqual(lfs.vehicle_type, "Rover")
    ...
    def test_write_summary_files(self) -> None:
        ...
        lfs = LocalFilesystem(self.test_dir, "vehicle_type", None, False)  # noqa: FBT003
    ...
    def test_new_vehicle_dir(self, mock_join) -> None:
        ...
        self.assertEqual(result, "base_dir/new_dir")
    ...
    def test_vehicle_image_filepath(self) -> None:
        ...
        with patch("os.path.join") as mock_join:
            ...
            self.assertEqual(result, "vehicle_dir/vehicle.jpg")
    ...
    def test_tempcal_imu_result_param_tuple(self) -> None:
        ...
        with patch("os.path.join") as mock_join:
            ...
            self.assertEqual(
                result,
                ("03_imu_temperature_calibration_results.param", "vehicle_dir/03_imu_temperature_calibration_results.param"),
            )
    ...
    def test_zip_file_path(self) -> None:
        ...
        with patch("os.path.join") as mock_join:
            ...
            self.assertEqual(result, "vehicle_dir/vehicle_name.zip")
    ...
    def test_get_download_url_and_local_filename(self) -> None:
        ...
        with patch("os.path.join") as mock_join:
            ...
            self.assertEqual(result, ("http://example.com/file", "vehicle_dir/dest_local"))
    ...
    def test_get_upload_local_and_remote_filenames(self) -> None:
        ...
        with patch("os.path.join") as mock_join:
            ...
            self.assertEqual(result, ("vehicle_dir/source_local", "dest_on_fc"))
            mock_join.assert_called_once_with("vehicle_dir", "source_local")


class TestCopyTemplateFilesToNewVehicleDir(unittest.TestCase):  # pylint: disable=missing-class-docstring
    @patch("os.path.exists")
    @patch("os.listdir")
    @patch("os.path.join")
    @patch("shutil.copytree")
    @patch("shutil.copy2")
    def test_copy_template_files_to_new_vehicle_dir(

...
def configuration_steps_strings() -> None:  # noqa: PLR0915 # pylint: disable=too-many-statements
    ...
    _config_steps_strings = _("Remote controller is mandatory in the initial configuration and tunning phases. Later might be required for operation and/or safety")
    ...
    _config_steps_strings = _("Because it can only be done after PID tunning is complete")

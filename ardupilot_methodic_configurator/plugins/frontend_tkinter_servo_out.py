...
from ardupilot_methodic_configurator.plugins.data_model_servo_out import (
    ServoOutDataModel,
    ServoOutRecommendationStatus,
)
...
class ServoOutView(Frame):
    ...
    def _refresh_summary(self) -> None:
        recommendations, message, _status = self.model.get_recommendations()
        if recommendations:
    ...
    def _refresh_parameter_table(self) -> None:
        """Show the assignments and upload selections added to the current step."""

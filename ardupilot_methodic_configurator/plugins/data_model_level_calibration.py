...
class LevelCalibrationDataModel:  # pylint: disable=too-few-public-methods
    ...
    def start_level_calibration(self, cancel_requested: Callable[[], bool] | None = None) -> tuple[bool, str]:

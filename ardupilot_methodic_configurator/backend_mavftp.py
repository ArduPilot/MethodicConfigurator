...
class MAVFTP:  # pylint: disable=too-many-instance-attributes
    ...
    def cmd_set(self, args: list[str]) -> MAVFTPReturn:  # noqa: PLR0911
    ...
    def __check_read_finished(self) -> bool:  # noqa: PLR0915
    ...
    def __handle_burst_read(  # noqa: C901, PLR0911, PLR0912, PLR0915
        self, op: FTP_OP, _m: MavlinkObject
    ) -> MAVFTPReturn:  # pylint: disable=too-many-statements,too-many-branches,too-many-return-statements
    ...
    def __mavlink_packet(  # noqa: C901, PLR0911
        self, m: MavlinkObject
    ) -> MAVFTPReturn:  # pylint: disable=too-many-branches, too-many-return-statements
    ...
    @staticmethod
    def ftp_param_decode(  # noqa: PLR0911, PLR0915
        data: bytes,
    ) -> ParamData | None:  # pylint: disable=too-many-locals,too-many-statements,too-many-branches,too-many-return-statements
...
def auto_detect_serial() -> list[mavutil.SerialPort]:
    ...
    if not serial_list and os.name == "posix":
        serial_list = [
            mavutil.SerialPort(
                device=port.device,

...
class MotorTestView(Frame):  # pylint: disable=too-many-instance-attributes
    ...
    def _create_widgets(self) -> None:
        ...
        # --- Battery Status ---
        battery_frame = ttk.LabelFrame(content_frame, text=_("Battery Status"))
        battery_frame.pack(padx=10, pady=5, fill="x")
        self.batt_voltage_label = ttk.Label(battery_frame, text=_("Voltage: N/A"))
        self.batt_voltage_label.pack(side="left", padx=10)
        self.batt_current_label = ttk.Label(battery_frame, text=_("Current: N/A"))

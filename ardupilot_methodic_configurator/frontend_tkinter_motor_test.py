...
class MotorTestView(Frame):  # pylint: disable=too-many-instance-attributes
    ...
    def __init__(
        ...
        self._content_frame: Union[ttk.Frame, None] = None  # Store reference to content frame for widget searches
    ...
    def _update_diagram(self) -> None:  # pylint: disable=too-many-locals
    ...
    def _test_all_motors(self) -> None:
        ...
        try:
            ...
            for motor_number in range(1, self.model.motor_count + 1):
                ...
                # Reset status after a short delay
                self.root_window.after(2000, lambda m=motor_number: self._update_motor_status(m, _("Ready"), "blue"))  # type: ignore[misc]

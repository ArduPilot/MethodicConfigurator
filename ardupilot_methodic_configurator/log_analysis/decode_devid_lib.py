...
This file is part of the ArduPilot source code and is is copied here by a periodic task.
DO NOT EDIT THIS FILE DIRECTLY. Instead, edit the original file in the ArduPilot source tree.
"""

...
def select_matplotlib_backend() -> str:
    ...
    for backend in interactive_backends:
        try:
            ...
            return backend
        except (ImportError, OSError, AttributeError, RuntimeError, Exception):
...
from pymavlink import mavutil  # pylint: disable=wrong-import-position
from pymavlink.rotmat import Vector3  # pylint: disable=wrong-import-position

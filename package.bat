...
rem python3.11.exe -m PyInstaller --onefile --noconfirm --add-data "4.4.4-test-params\00_default.param;4.4.4-test-params" --add-data "apm.pdef.xml;." --add-data "apm.pdef.4.3.8-params.xml;." --add-data "apm.pdef.4.4.4-params.xml;." --add-data "apm.pdef.4.5.1-params.xml;." --add-data "apm.pdef.4.6.0-DEV-params.xml;." --add-data "ArduPilot_icon.png;." --add-data "ArduCopter_configuration_steps.json;." ardupilot_methodic_configurator.py

...
Do not make changes here, these parameters will be set later on the [Motor/Propeller order and direction test](#7-assemble-propellers-and-perform-the-first-flight) section

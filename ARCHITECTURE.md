...
To satisfy the system design requirements described above the following user interface sub-applications were developed:
...
1. Create or open project:
   1. contains no data_model yet. TODO: refactor the code to move the business logic out of the UI code.
1. Component editor:

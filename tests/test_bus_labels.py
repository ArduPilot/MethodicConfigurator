...
class TestBusLabels:
    ...
    def test_serial_bus_labels_defined(self) -> None:
        ...
        assert SERIAL_BUS_LABELS["SERIAL1"] == "Telem1"
        assert SERIAL_BUS_LABELS["SERIAL2"] == "Telem2"
        assert SERIAL_BUS_LABELS["SERIAL3"] == "GPS1"
        assert SERIAL_BUS_LABELS["SERIAL4"] == "GPS2"
    ...
    def test_get_connection_type_tuples_with_labels_serial_ports(self) -> None:
        ...
        assert result[4] == ("SERIAL5", "SERIAL5 (SERIAL5)")
        assert result[5] == ("SERIAL6", "SERIAL6 (SERIAL6)")
        assert result[6] == ("SERIAL7", "SERIAL7 (SERIAL7)")
        assert result[7] == ("SERIAL8", "SERIAL8 (SERIAL8)")

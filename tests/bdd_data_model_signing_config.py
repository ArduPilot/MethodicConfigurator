...
class TestSigningConfigPersistence:
    ...
    def test_manager_creates_data_directory_automatically(self, tmp_path) -> None:
        ...
        assert manager._config_file.exists()  # pylint: disable=protected-access
    ...
    def test_configurations_survive_file_format_version_upgrade(self, tmp_path) -> None:
        ...
        old_format = STANDARD_JSON_CONFIG.copy()
        manager._config_file.write_text(json.dumps(old_format))  # pylint: disable=protected-access
